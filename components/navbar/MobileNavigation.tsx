        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-6 sm:px-3 flex flex-col items-center">
            ...
            <div className="space-y-3 w-full max-w-[400px]">
              <h3 className="text-purple-200 font-medium text-sm uppercase tracking-wider text-center">
                {t("Nav.nav-mobile")}
              </h3>
          ...
          <footer className="flex flex-col gap-6">
            ...
            <div className="pt-4 pb-3 border-t border-purple-700">
              <div className="mt-3 px-2 space-y-1 flex justify-center">
                ...
                >
                  <Button
                    className="w-full bg-white text-purple-900 hover:bg-purple-50 rounded-full px-6 py-2 font-medium hover:cursor-pointer"
